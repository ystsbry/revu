...
The dashboard is being built up in stages. Today it boots the navigation
shell with a placeholder repository list; the repository registry, PR
list, and review actions land in later changes. The existing commands
("revu open", "revu review", "revu resume", ...) are unaffected and keep

...
// A non-zero exit from codex is reported with the session it was for.
...
func TestInstallHint(t *testing.T) {
	...
	for _, want := range []string{"codex", "PATH", "developers.openai.com"} {
